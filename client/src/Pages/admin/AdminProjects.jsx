...
function AdminProjects() {
  ...
  const handleUpdateSection = async (section) => {
    ...
    try {
      const res = await axios.put("http://localhost:5000/api/projects", formData, {
        headers: {
  ...
  if (loading) return <p>Loading projects content...</p>;
  ...
  return (
    <div className="admin-home-container">
      ...
      <h1>Manage Projects Page Content</h1>
