...
function AdminDonate() {
  ...
  const handleUpdateSection = async (section) => {
    ...
    try {
      ...
      const refreshed = await axios.get('http://localhost:5000/api/donate');
      setDonateContent(refreshed.data);
                ...
                <>
                  ...
                  {typeof value === 'string' && (
                    <div style={{ marginTop: '8px' }}>
                      ...
                      <img src={`http://localhost:5000${value}?v=${Date.now()}`} alt={key} width="200" />
                    </div>
                  )}
                </>
              ) : (
